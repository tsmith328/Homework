...
public class RegexAssignment{
    ...
    public static boolean testEmail(String email){
        return email.matches("[A-z][A-z0-9_\\-\\.]*@[A-z][A-z0-9_\\-\\.]*\\.(com|org|net)");
    }
    ...
    public static boolean testAddress(String address){
        return address.matches("\\d{1,5} [A-z0-9\\. -]*\\n[A-Z][A-z0-9 \\.-]*,? [A-Z]{2} \\d{5}(-\\d{4})?");
    }
    ...
    public static boolean testJavaExecutable(String java){
        return java.matches("(.|\\n)*public static void main\\(String\\[\\] [^0-9][A-z,0-9,-,\\$]*\\)(.|\\n)*");
    }
}